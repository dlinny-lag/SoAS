...
public class ComboTreeNodeCollection : IList<ComboTreeNode>, IList, INotifyCollectionChanged {
	...
	public ComboTreeNode this[string name] {
		get {
			foreach (ComboTreeNode o in this) {
				if (Object.Equals(o.Key, name)) return o;
			}
	...
	public bool ContainsKey(string name) {
		foreach (ComboTreeNode o in this) {
			if (Object.Equals(o.Key, name)) return true;
		}
	...
	public bool Remove(string name) {
		for (int i = 0; i < _innerList.Count; i++) {
			if (Object.Equals(_innerList[i].Key, name)) {
	...
	public int IndexOf(string name) {
		for (int i = 0; i < _innerList.Count; i++) {
			if (Object.Equals(_innerList[i].Key, name)) return i;
		}
